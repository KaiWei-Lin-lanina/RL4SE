# RL4SE  
This repository accompanies from our recent work, "A Survey of Reinforcement Learning for Software Engineering".It provides supplementary materials for our study, including datasets, code, and a list of relevant papers.The focus is on the application of Reinforcement Learning (RL) to a broad range of Software Engineering (SE) tasks.  
